...
API_SECRET = os.getenv('API_SECRET', 'ZEUS_SECRET')  # ⚠️ غيّره في ENV
NODE_BACKEND_URL = os.getenv('NODE_BACKEND_URL', 'https://novels-node-backend-production.up.railway.app')
MARKAZ_COOKIES = os.getenv('MARKAZ_COOKIES', 'ضع_هنا_الكوكيز_الخاصة_بك_كاملة')
